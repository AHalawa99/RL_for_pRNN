...
for actenc in ['SpeedHD', 'Velocities']:#, 'OneHot']:
    for k in range(7):
        for seed in range(1, 7):
            ...
            netname = 'fig3enets/fig3e_newRollout-R_k' + str(k) + '_' + actenc + f'_S{seed}-s{seed}'
            ...
            rollout_data[actenc_dict[actenc], k, seed-1] = hill_fit

np.savez('rollout_data_results.npz', rollout_data=rollout_data)
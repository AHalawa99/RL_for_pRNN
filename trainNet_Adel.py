...
parser.add_argument("--lognormal_init", action='store_true', default=False,
                    help="Use lognormal initialization for weights when using Exponentiated Gradient Descent?")
...
if args.contin: #continue previous training, so load net from folder
    ...
    predictiveNet = PredictiveNet(env,
                                  ...
                                  init = 'log_normal' if args.lognormal_init else 'xavier',
                                  eg_lr = args.eg_lr,
